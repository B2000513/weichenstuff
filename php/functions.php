...
if ($_GET['op'] == 'userSignUp') {
    ...
    if (!$found) {
        ...
        $mail->setFrom('xwkhor0713@gmail.com');
        $mail->addAddress($email);

        $mail->isHTML(true);

        $mail->Subject = 'Default Password for Wastex';
...
if ($_GET['op'] == 'addPickup') {
    ...
    $mail->Body = "Thank you for scheduling your waste pickup with wasteX. Here are the details of your request:<br>
