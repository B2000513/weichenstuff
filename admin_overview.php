    ...
    <div class="content-container">
        ...
        <div class="report-card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12"> 
                        <div class="form-group">
                            ...
                            <input type="text" id="date-range1" placeholder="Select Date Range ▾" required="required" class="date filter" value="<?php echo $today . ' to ' . $createdDate; ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="message" id="message1" style="display:none;">
                ...
                <p>Please choose a wider date range.</p>
            </div>
        </div>

        <!-- Pickup Statistics -->
        <div class="report-card">
            <h2>Schedule Pickup Statistics</h2>
            <div class="report-content">
                <div class="row">
                    <div class="col-md-9">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="date-range2" placeholder="Select Date Range ▾" required="required" class="date filter" value="<?php echo $today . ' to ' . $createdDate; ?>">
                        </div>
                    </div>

                    <!-- col-md-3 (Generate Button) -->
                    <div class="col-md-3">
                        <div class="form-group">
        ...
        <div class="report-card full-width">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="date-range3" placeholder="Select Date Range ▾" required="required" class="date filter" value="<?php echo $today . ' to ' . $createdDate; ?>">
                        </div>
                    </div>
            ...
            <div class="chart-container" id="curve_chart" style="width: 100%; height: 350px;"></div>
            ...
            $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var barColors = ["#2ecc71", "#D397F8", "#3498db"];
                        if (myChart2) {
        ...
        document.getElementById("btn1").addEventListener("click", function(event) {
            ...
            $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    type: 'GET', // or 'POST' based on your preference
                    data: {
                        issueReportedDate: issueReportedDate,
                    ...
                    success: function(response) {
                        ...
                        var yValues = response.yValues; // Assume your server returns an object with a 'values' array
                        var result = response.result;
                        var barColors = ["#2ecc71", "#f39c12", "#D397F8", "#3498db"];
                        if (myChart) {
